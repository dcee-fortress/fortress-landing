...
import {
  PERSONAL_PROTECTIVE_EQUIPMENT_OPTIONS,
  getSafetyHealthHref,
} from "@/lib/projectRoutes"

export default function PersonalProtectiveEquipmentView({ projectId, projectName }) {
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="max-w-2xl text-sm text-zinc-500 sm:text-base">
          Choose PPE received or PPE issued to open files and dashboards.
        </p>
      </header>

      <div className="app-choice-grid">
        {PERSONAL_PROTECTIVE_EQUIPMENT_OPTIONS.map((item) => (
          <ChoiceCard
            key={item.key}
