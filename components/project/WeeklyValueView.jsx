    ...
    <li>
      ...
      >
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          <div className="app-icon-tile app-icon-tile--violet">
    ...
    <div className="space-y-6">
      <header className="space-y-2">
        ...
        <p className="max-w-2xl text-zinc-500">
          Weekly files are created from the project start date through the current week. Totals
          roll up from daily hourly entries, and you can edit those daily files at any time.
        </p>
      </header>
