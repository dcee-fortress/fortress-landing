...
/**
 * Actual progress update keeps the user's edited document content if it has been
 * saved. Only fall back to the live valuation snapshot when there is no saved
 * actual-progress text yet.
 */
