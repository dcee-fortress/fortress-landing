export const DASHBOARD_VIEWS = {
  ...
  finance: {
    label: "Finance",
    description: "Petty cash and purchases",
    icon: "wallet",
  },
  "petty-cash": {
    label: "Petty cash",
  ...
  "goods-acquired": {
    label: "Goods acquired",
    description: "Record goods acquired for this project",
    icon: "package",
  },
  purchases: {
    label: "Purchases",
    description: "Goods received and goods acquired",
    icon: "package",
  },
  "safety-health": {
    label: "Safety & Health",
...
export const FINANCE_MODULES = [
  ...
  },
  {
    view: "purchases",
    label: "Purchases",
    description: "Goods received and goods acquired for this project",
    icon: "package",
  },
]
...
export const PURCHASES_MODULES = [
  ...
  },
  {
    view: "goods-acquired",
    label: "Goods acquired",
    description: "Record and track goods acquired for this project",
    icon: "package",
  },
]
...
export const GOODS_ACQUIRED_PERIODS = [
  {
    period: "daily",
    label: "Daily goods acquired",
    description: "Daily goods acquired records from project start",
    icon: "clock",
  },
  {
    period: "weekly",
    label: "Weekly goods acquired",
    description: "Weekly goods acquired summaries in 7-day periods",
    icon: "calendar-range",
  },
  {
    period: "monthly",
    label: "Monthly goods acquired",
    description: "Monthly goods acquired summaries from project start",
    icon: "calendar-days",
  },
  {
    period: "project-to-date",
    label: "Project to date",
    description: "Goods acquired totals for the whole project",
    icon: "hard-hat",
  },
]
...
export function getGoodsAcquiredHref(projectId) {
  return getDashboardHref(projectId, "goods-acquired")
}
