...
export const PPE_RECEIVED_PERIODS = [
  {
    ...
    description: "Daily PPE received records from project start",
    icon: "clock",
  },
  {
    period: "weekly",
    label: "Weekly PPE received",
    description: "Weekly PPE received summaries in 7-day periods",
    icon: "calendar-range",
  },
  {
    period: "monthly",
    label: "Monthly PPE received",
    description: "Monthly PPE received summaries from project start",
    icon: "calendar-days",
  },
  {
    period: "project-to-date",
    label: "Project to date",
    description: "PPE received totals for the whole project",
    icon: "hard-hat",
  },
]
...
export const PPE_ISSUED_PERIODS = [
  {
    ...
    description: "Daily PPE issued records from project start",
    icon: "clock",
  },
  {
    period: "weekly",
    label: "Weekly PPE issued",
    description: "Weekly PPE issued summaries in 7-day periods",
    icon: "calendar-range",
  },
  {
    period: "monthly",
    label: "Monthly PPE issued",
    description: "Monthly PPE issued summaries from project start",
    icon: "calendar-days",
  },
  {
    period: "project-to-date",
    label: "Project to date",
    description: "PPE issued totals for the whole project",
    icon: "hard-hat",
  },
]
