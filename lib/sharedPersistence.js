...
import { mergeSharedStorageValue, purgeDeletedProjectsFromStorage, stripDemoSharedValue } from "@/lib/sharedStorageMerge"
import {
  ...
  const pull = async (options = {}) => {
    ...
    try {
      ...
      for (const key of syncKeys) {
        ...
        const mergedValue = initialized
          ? mergeSharedStorageValue(key, localValue, liveValue)
          : liveValue || mergeSharedStorageValue(key, localValue, liveValue)
