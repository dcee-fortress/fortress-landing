...
/**
 * Demo valuation rows are never seeded. Local and live both show entered project data.
 */
export function shouldSeedLocalDevValuations() {
  return false
}
...
export function resetDemoValuesPreference() {
  ...
  removeGroveItem(DEMO_VALUES_STORAGE_KEY)
}
