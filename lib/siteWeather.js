...
export function weatherTonePalette(tone) {
  switch (tone) {
    case "sunny":
      return { bg: "#1d8fd6", chip: "#1677b8", text: "#ffffff", muted: "#e8f6ff", hourBg: "#fff8e8", hourText: "#8a5a00", accent: "#f5c14a" }
    case "partly":
      return { bg: "#2b9adf", chip: "#1f7fbd", text: "#ffffff", muted: "#e6f5ff", hourBg: "#eef8ff", hourText: "#0f4a6e", accent: "#7ec8e8" }
    case "rain":
      return { bg: "#3d6ea8", chip: "#2f5786", text: "#ffffff", muted: "#e4eef8", hourBg: "#eef3f9", hourText: "#1d3557", accent: "#8fb4d9" }
    case "storm":
      return { bg: "#4a4f86", chip: "#383c6b", text: "#ffffff", muted: "#eceef8", hourBg: "#f3f3f8", hourText: "#2a2d4d", accent: "#c4b5fd" }
    case "fog":
      return { bg: "#6b7784", chip: "#55616d", text: "#ffffff", muted: "#eef1f4", hourBg: "#f4f6f7", hourText: "#33404c", accent: "#c5ced6" }
    case "snow":
      return { bg: "#5a84a3", chip: "#456b88", text: "#ffffff", muted: "#eaf3f9", hourBg: "#f3f8fc", hourText: "#2a4558", accent: "#d7e7f2" }
    default:
      return { bg: "#5b6b7c", chip: "#465564", text: "#ffffff", muted: "#e8eef3", hourBg: "#f3f5f7", hourText: "#2d3a46", accent: "#cbd5e1" }
  }
}
