  ...
  if (report.equipment.length === 0) {
    ...
    autoTable(doc, {
      ...
      foot: [[
        {
          content:
            "Equipment listed from operators marked present in the register. Supplier, plant name, and plant number copy from that register row. Enter start and finish hours, or type hours operating directly.",
          colSpan: 7,
        },
      ]],
      ...TABLE_OPTIONS,
