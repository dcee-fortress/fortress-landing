...
function mergeDailyProgressReports(existingReports, generatedReports) {
...
export function ensureProgressReportsExist(projectId) {
  ...
  try {
    ...
    registry.files[projectId].dailyProgressReports = mergeDailyProgressReports(existingDaily, generatedDaily)
    writeProjectsRegistry(registry)
  } catch {
    // Silently fail
  }
