...
export function ensureProgressReportsExist(projectId) {
  ...
  try {
    ...
    registry.files[projectId].weeklyProgressReports = mergeProgressReports(
      existing,
      generated,
      projectId,
      projectStart
    )
    registry.files[projectId].progressReports = registry.files[projectId].weeklyProgressReports
    registry.files[projectId].dailyProgressReports = mergeDailyProgressReports(
      existingDaily,
      generatedDaily,
