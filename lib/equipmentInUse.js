...
export function getEquipmentInUseDetailDescription(period) {
  if (period === "daily") {
    return "Equipment listed here is pulled from the operator register when marked present. Enter start and finish hours, or type hours operating directly. When both start and finish are filled, hours operating calculates automatically."
  }
